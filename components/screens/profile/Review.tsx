...
const Review:FC<ReviewProps> = ({author, comment, rating}) => {
  ...
  return (
    <View className="px-4 py-4 mb-4" style={{backgroundColor: "rgba(21, 22, 22, 0.5)", boxShadow: "0px 0px 8px rgba(204, 204, 204, 0.2)", borderRadius: 8, borderWidth: 1, borderColor: "#191919"}}>
